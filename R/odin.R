...
nimue_booster_ <- R6::R6Class(
  ...
  private = list(
    ...
    registration = function() {
      if (FALSE) {
        .C("nimue_booster_rhs_dde", package = "squire.page.sarsX")
        .C("nimue_booster_rhs_desolve", package = "squire.page.sarsX")
        .C("nimue_booster_initmod_desolve", package = "squire.page.sarsX")
        .C("nimue_booster_output_dde", package = "squire.page.sarsX")
      }
    },
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
      ...
      private$ptr <- .Call("nimue_booster_create", user, PACKAGE = "squire.page.sarsX")
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      ...
      .Call("nimue_booster_set_user", private$ptr, user, PACKAGE = "squire.page.sarsX")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("nimue_booster_initial_conditions", private$ptr, t, PACKAGE = "squire.page.sarsX")
    },

    rhs = function(t, y) {
      .Call("nimue_booster_rhs_r", private$ptr, t, y, PACKAGE = "squire.page.sarsX")
    },
    ...
    contents = function() {
      .Call("nimue_booster_contents", private$ptr, PACKAGE = "squire.page.sarsX")
    },
